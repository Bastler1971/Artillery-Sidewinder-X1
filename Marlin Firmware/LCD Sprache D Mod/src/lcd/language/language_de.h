...
namespace Language_de {
  ...
  PROGMEM Language_Str LANGUAGE                            = _UxGT("Deutsch"); //Bastler1971 (Deutsche)
  ...
  PROGMEM Language_Str MSG_PREHEAT_1                       = PREHEAT_1_LABEL _UxGT(" Vorheizen"); //Bastler1971 (Vorwärmen)
  PROGMEM Language_Str MSG_PREHEAT_1_H                     = PREHEAT_1_LABEL _UxGT(" Vorheizen") " ~"; //Bastler1971 (Vorwärmen)
  PROGMEM Language_Str MSG_PREHEAT_1_END                   = PREHEAT_1_LABEL _UxGT(" Extr. Vorheizen"); //Bastler1971 (Extr. Vorwärmen)
  PROGMEM Language_Str MSG_PREHEAT_1_END_E                 = PREHEAT_1_LABEL _UxGT(" Extr. Vorheiz. ~"); //Bastler1971 (Extr. Vorwärm.)
  PROGMEM Language_Str MSG_PREHEAT_1_ALL                   = PREHEAT_1_LABEL _UxGT(" Alles Vorheizen"); //Bastler1971 (Alles Vorwärmen)
  PROGMEM Language_Str MSG_PREHEAT_1_BEDONLY               = PREHEAT_1_LABEL _UxGT(" Bett Vorheizen"); //Bastler1971 (Bett Vorwärmen)
  PROGMEM Language_Str MSG_PREHEAT_1_SETTINGS              = PREHEAT_1_LABEL _UxGT(" Einstellungen");
  PROGMEM Language_Str MSG_PREHEAT_2                       = PREHEAT_2_LABEL _UxGT(" Vorheizen"); //Bastler1971 (Vorwärmen)
  PROGMEM Language_Str MSG_PREHEAT_2_H                     = PREHEAT_2_LABEL _UxGT(" Vorheizen") " ~"; //Bastler1971 (Vorwärmen)
  PROGMEM Language_Str MSG_PREHEAT_2_END                   = PREHEAT_2_LABEL _UxGT(" Extr. Vorheizen"); //Bastler1971 (Extr. Vorwärmen)
  PROGMEM Language_Str MSG_PREHEAT_2_END_E                 = PREHEAT_2_LABEL _UxGT(" Extr. Vorheiz. ~"); //Bastler1971 (Extr. Vorwärm)
  PROGMEM Language_Str MSG_PREHEAT_2_ALL                   = PREHEAT_2_LABEL _UxGT(" Alles Vorheizen"); //Bastler1971 (Alles Vorwärmen)
  PROGMEM Language_Str MSG_PREHEAT_2_BEDONLY               = PREHEAT_2_LABEL _UxGT(" Bett Vorheizen"); //Bastler1971 (Bett Vorwärmen)
  PROGMEM Language_Str MSG_PREHEAT_2_SETTINGS              = PREHEAT_2_LABEL _UxGT(" Einstellungen");
  PROGMEM Language_Str MSG_PREHEAT_CUSTOM                  = _UxGT("b.def. Heizen"); //Bastler1971 (benutzerdef. Heizen)
  ...
  PROGMEM Language_Str MSG_G26_HEATING_NOZZLE              = _UxGT("G26 heizt Nozzle"); //Bastler1971 (G26 Heating Nozzle)
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_OPTION_PURGE    = _UxGT("Mehr laden"); //Bastler1971 (Mehr entladen)
  ...
  //                                       ...oder 2 Zeilen auf einem 3-Zeilen-Display.
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_PURGE         = _UxGT(MSG_3_LINE("Warte auf", "laden des", "Filaments...")); //Bastler1971 (Entladen des)
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_CONT_PURGE    = _UxGT(MSG_3_LINE("Klicke um", "die Fila-Beladung", "zu beenden")); //Bastler1971 (die Fila-Entladung)
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_PURGE         = _UxGT(MSG_1_LINE("Beladen...")); //Bastler1971 (Entladen...)
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_CONT_PURGE    = _UxGT(MSG_2_LINE("Klick zum beenden", "der Fila-Beladung")); //Bastler1971 (der Fila-Entladung)
